		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zatualizacaocadastral-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zatualizacaocadastral-display": {
								"semanticObject": "zatualizacaocadastral",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zatualizacaocadastral",
									"url": sap.ui.require.toUrl("zatualizacaocadastral")
								}
							}
						}
					}
