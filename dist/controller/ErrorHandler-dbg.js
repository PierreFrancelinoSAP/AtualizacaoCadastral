sap.ui.define([
    ...
    return UI5Object.extend("zatualizacaocadastral.controller.ErrorHandler", {
         ...
         * @public
         * @alias zpocreation.controller.ErrorHandler
         */
        constructor : function (oComponent) {
            var oMessageManager = sap.ui.getCore().getMessageManager(),
                ...
                oMessageModel.setSizeLimit(1000);

            this._oComponent = oComponent;
            this._bMessageOpen = false;

            // oMessageModel.setSizeLimit(2);
